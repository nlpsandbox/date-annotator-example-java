...
[![GitHub Release](https://img.shields.io/github/release/Sage-Bionetworks/nlp-sandbox-date-annotator-example-java.svg?include_prereleases&color=94398d&labelColor=555555&logoColor=ffffff&style=for-the-badge&logo=github)](https://github.com/Sage-Bionetworks/nlp-sandbox-date-annotator-example-java/releases)
[![GitHub CI](https://img.shields.io/github/workflow/status/Sage-Bionetworks/nlp-sandbox-date-annotator-example-java/ci.svg?color=94398d&labelColor=555555&logoColor=ffffff&style=for-the-badge&logo=github)](https://github.com/nlpsandbox/date-annotator-example-java/actions)
[![GitHub License](https://img.shields.io/github/license/Sage-Bionetworks/nlp-sandbox-date-annotator-example-java.svg?color=94398d&labelColor=555555&logoColor=ffffff&style=for-the-badge&logo=github)](https://github.com/nlpsandbox/date-annotator-example-java/blob/develop/LICENSE)
...
Date Annotator using Docker (production mode) or Maven.
...
1. Download the latest OpenAPI specification of the [NLP Sandbox Date
   Annotator].
...
6. Generate the server stub using the generator of your choice (here `spring`).
   The option `-o` is to specify the name of the folder where the files
...
7. Start your new NLP tool locally by following the instructions outlines in the
   section [Running with Maven](#Running-with-Maven). Open the page
...
[nlpsandbox/date-annotator-example-java]: https://hub.docker.com/r/nlpsandbox/date-annotator-example-java
[GitHub template]: https://github.com/nlpsandbox/date-annotator-example-java/generate
[NLP Sandbox]: nlpsandbox.io
[nlpsandbox/date-annotator-example]: https://github.com/nlpsandbox/date-annotator-example
[Apache License 2.0]: https://github.com/nlpsandbox/date-annotator-example-java/blob/develop/LICENSE
